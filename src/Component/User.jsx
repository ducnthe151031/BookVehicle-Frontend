...
import { User, Edit, Trash2, Plus, X, Search, ChevronLeft, ChevronRight, Filter } from 'lucide-react';
...
const UserList = () => {
    const { customer } = useAuth(); // Lấy thông tin người dùng hiện tại
    ...
    const isOperator = customer?.role === 'ROLE_OPERATOR';
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-6 px-4">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-6">
                    ...
                    {isOperator && (
                    <h1 className="text-2xl font-bold text-gray-900 mb-1">Danh Sách Người Dùng</h1>
                    )}
                    {isAdmin && (
                    <p className="text-gray-600 text-sm">Quản lý thông tin người dùng trong hệ thống</p>
                    )}
                    {isOperator && (
                    <p className="text-gray-600 text-sm">Xem thông tin người dùng trong hệ thống</p>
                    )}
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    {showFilterForm && (
                        <div className="p-4 bg-gray-50 border-b">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                {/* Chỉ hiển thị filter trạng thái cho Admin */}
                                {isAdmin && (
                                    <div>
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Ngân Hàng</th>
                                        ...
                                        {/* Chỉ hiển thị cột Trạng thái cho Admin */}
                                        {isAdmin && (
                                    ...
                                    {users.map((user) => (
                                        <tr key={user.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-800">{user.bankName || 'N/A'}</td>
                                            <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-800">{user.bankNumber || 'N/A'}</td>
                                            {isAdmin && (
                    ...
                    {/* Delete Confirmation Modal - Chỉ hiển thị cho Admin */}
                    ...
                    {/* Drawer Form - Chỉ hiển thị cho Admin */}
                    {isAdmin && (
